Репозиторий изначально создан для практических работ данного курса и не изменялся под данное задание.
Именование репозитория соответствует названию курса. Практические работы располагаются в соответствующих директориях и просто пронумерованы.
Файл README добавлен исключительно для данного задания и содержит структуру курса.
Каждый коммит именован в соответствии с номером занятия и количеством практических работ в нём либо в соответствии с выполненными работами в проекте.
